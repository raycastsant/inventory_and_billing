...
class Helper
{
    ...
    /**Imprime un Thumbail como el preview del fileInput de Kartik */
    public static function ImgThumbailWidget($imgurl=null, $zoomBtnId='zoomBtn', $imgTitle='', $imgId='', $width='auto', $height='auto') {
        if($imgurl != null) {
            return '<div class="file-preview-frame krajee-default  file-preview-initial file-sortable kv-preview-thumb" id="thumb-producto-imagefile-init-0" data-fileindex="init-0" data-fileid="thumb-producto-imagefile-init-0" data-template="image">
                <div class="kv-file-content">
                    <img id="'.$imgId.'" class="file-preview-image  kv-preview-data" src="'.$imgurl.'" title="'.$imgTitle.'" style="width:'.$width.'; height:'.$height.';">
                </div>
                <div class="file-thumbnail-footer">
                    <div class="file-actions">
                        <div class="file-footer-buttons">
                            <button type="button" id="'.$zoomBtnId.'" class="kv-file-zoom btn btn-xs btn-kv btn-default btn-outline-secondary" title="Ampliar"><i class="glyphicon glyphicon-zoom-in"></i></button>     
                        </div>
                    </div>
                </div>
            </div>';
