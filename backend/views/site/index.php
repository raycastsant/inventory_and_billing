...
//use backend\modules\Reportes\controllers\ReportesController;

/* @var $this yii\web\View */

$this->title = 'TDEA-Facturación-Inventario';
?>
...
<div class="site-index">
    ...
    <h3 id="prods-baja-cant"><span class="label info-nav-badge">Productos con baja existencia en almacén</span>
        <span id="prods-baja-cant-title" class="label info-nav-badge">0</span></h3>
    <div class="well">
    ...
    <div id="ofertas-por-fact" class="row">
        <h3><span class="label warning-nav-badge">Ofertas pendientes por factura</span>
            <span id="ofertas-por-fact-title" class="label warning-nav-badge">0</span></h3>
            <div class="col-md-5 well" style="max-width:700px">
                <h4><span class="label warning-nav-badge">Servicios</span>
                    <span id="servicios-por-fact-title" class="label warning-nav-badge">0</span></h4>
            ...
            <div class="col-md-5 well" style="max-width:700px">
                <h4><span class="label warning-nav-badge">Ventas</span>
                    <span id="ventas-por-fact-title" class="label warning-nav-badge">0</span></h4>
                <div class="table-responsive" style="max-height:700px">
    ...
    <div id="facturas-pend" class="row">
        <h3><span class="label green-nav-badge">Facturas pendientes por cobrar</span>
            <span id="facturas-pend-title" class="label green-nav-badge">0</span></h3>
            <div class="col-md-5 well" style="max-width:700px">
                <h4><span class="label green-nav-badge">Servicios</span>
                    <span id="servicios-pend-title" class="label green-nav-badge">0</span></h4>
            ...
            <div class="col-md-5 well" style="max-width:700px">
                <h4><span class="label green-nav-badge">Ventas</span>
                    <span id="ventas-pend-title" class="label green-nav-badge">0</span></h4>
                <div class="table-responsive" style="max-height:800px">
