...
/**
 * This is the model class for table "devolucion_ventas".
 *
 * @property int $id
 ...
 * @property OrdenVenta $orden
 * @property Producto $producto
 */
class DevolucionVenta extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['orden_id'], 'exist', 'skipOnError' => true, 'targetClass' => OrdenVenta::className(), 'targetAttribute' => ['orden_id' => 'id']],
    ...
    {
        return $this->hasOne(OrdenVenta::className(), ['id' => 'orden_id']);
    }
