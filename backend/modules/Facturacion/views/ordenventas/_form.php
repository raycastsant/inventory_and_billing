...
<div class="orden-venta-form">
    ...
    <?php ob_start(); // output buffer the javascript to register later ?>
            <script>
               //Para actualizar el combo de los vehiculos 
              <?php if(!isset($model->ordenVenta->vehiculo_id)) 
                        echo "document.getElementById('ordenventa-cliente_id').onchange();";
                    else {
                        echo "var comboClient = document.getElementById('ordenventa-vehiculo_id');
                              comboClient.innerHTML = '<option value=\"\">-Seleccionar Vehículo-</option>' + comboClient.innerHTML;";
                    }
                ?>
