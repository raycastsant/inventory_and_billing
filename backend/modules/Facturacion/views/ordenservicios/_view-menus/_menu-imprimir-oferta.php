...
<div class="btn-group pull-right">
    <?php $form = ActiveForm::begin([
        'enableClientValidation' => false, 'options' => ['target' => '_blank'],
        'action' => Yii::$app->urlManager->createUrl(['reportes/reportes/acta-servicio-form'])
    ]);
    echo Html::submitButton(
        '<span class="glyphicon glyphicon-print"></span> Orden-servicio',
...
<div class="btn-group pull-right">
    ...
    echo Html::submitButton(
        '<span class="glyphicon glyphicon-print"></span> Acta-entrega',
        ['class' => 'btn btn-default']
    );

    echo $form->field($acta_entrega, 'cliente')->hiddenInput(['value' => $model->cliente->nombre])->label(false);
    ?>
    <?php ActiveForm::end(); ?>
</div>
