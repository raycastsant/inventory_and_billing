...
/**
 * ServicioSearch represents the model behind the search form of `backend\modules\Nomencladores\models\Servicio`.
 */
class ServicioSearch extends Servicio
{
    ...
    public function rules()
    {
        return [
            [['id'], 'integer'],
            [['nombre', 'descripcion', 'myPageSize'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        $query = Servicio::find()->where(['eliminado'=> false]);
