...
use backend\modules\Nomencladores\models\ServicioSearch;
...
class ServiciosController extends Controller
{
    ...
    public function actionDelete($id)
    {
       ...
       $model->save();
       TrazasController::insert("Eliminado servicio: ".$model->nombre, Servicio::tableName());
    ...
    protected function findModel($id)
    {
       /* if (($model = Servicio::findOne($id)) !== null) {
        ...
        if ( ($model = Servicio::findOne(['id'=>$id, 'eliminado'=>false]) ) !== null) {
            return $model;
       }
